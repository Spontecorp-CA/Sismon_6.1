...
import com.sismon.vista.controller.GestionEscenarioController;
...
public class GestionEscenarioIF extends javax.swing.JInternalFrame {

    private static GestionEscenarioIF instance = null;
     ...
     */
    private GestionEscenarioIF() {
        initComponents();
        this.escenarioManager = new EscenarioManager();
        init();
    }

    public static GestionEscenarioIF getInstance() {
        if (instance == null) {
            instance = new GestionEscenarioIF();
        }
        return instance;
    }

    private void init() {
        this.setTitle("Gestión de Escenarios");
    ...
    private void clearComboBox() {
        ...
        escenariosComboBox.addItem("... seleccione escenario");
    }

    private void fillDataTable() {
        String[] titles = {"Id", "Nombre", "Fecha", "Descripción"};
        ...
        if (escenarios != null && !escenarios.isEmpty()) {
            ...
            for (Escenario escenario : escenarios) {
                ...
                data[i][3] = escenario.getComentario();
                i++;
            }
    ...
    private void fillEscenariosComboBox() {
        ...
        } else if (realRadioButton.isSelected()) {
    ...
    private void initComponents() {
        ...
        escenariosButtonGroup.add(baseRadioButton);
        baseRadioButton.setText("Escenario Base");
        baseRadioButton.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        ...
        escenariosButtonGroup.add(realRadioButton);
        realRadioButton.setText("Mejor Visión");
        realRadioButton.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        realRadioButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                realRadioButtonActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(baseRadioButton, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(escenarioRadioButton, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(realRadioButton, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(18, 18, 18)
        ...
        jLabel5.setText("Lista de escenarios registrados");
                            ...
                            .addGroup(backPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(backPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(backPanelLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(nombreTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 349, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(backPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(backPanelLayout.createSequentialGroup()
                                            .addGap(27, 27, 27)
            ...
            if (escenarioSelected == null) {
                try {
                    if (escenarioManager.find(nombreTextField.getText().toUpperCase()) == null) {
                        ...
                        GestionEscenarioController generador;
                        if (baseRadioButton.isSelected()) {
                            generador = new GestionEscenarioController(
                                    nombreTextField.getText().toUpperCase(),
                                    fechaDateChooser.getDate(),
                                    descripcionTextField.getText(),
                                    progressBar,
                                    archivo,
                                    Constantes.ESCENARIO_BASE,
                                    null);
                        } else if (escenarioRadioButton.isSelected()) {
                            getEscenarioEntrada();
                            generador = new GestionEscenarioController(
                                    nombreTextField.getText().toUpperCase(),
                                    fechaDateChooser.getDate(),
                        ...
                        Contexto.showMessage("Escenario existente, debe usar otro nombre", Constantes.MENSAJE_ERROR);
                ...
                Contexto.showMessage("Escenario actualizado con éxito", Constantes.MENSAJE_INFO);
                fillDataTable();
                clearForm();
            }
        } else {
    ...
    private void eliminarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarButtonActionPerformed
        int id = (int) dataTable.getModel().getValueAt(dataTable.getSelectedRow(), 0);
        escenarioSelected = escenarioManager.find(id);
        int respuesta = JOptionPane.showConfirmDialog(this, "¿Desea eliminar el escenario "
                + escenarioSelected.getNombre() + "?",
                "Advertencia", JOptionPane.YES_NO_OPTION);
        if (respuesta == JOptionPane.YES_OPTION) {
            try {
                GestionEscenarioController gestor = new GestionEscenarioController(escenarioSelected, progressBar);
                gestor.execute();
                if (gestor.get()) {
                    clearForm();
                    fillDataTable();
                ...
                sismonlog.logger.log(Level.SEVERE, "No pudo eliminar el escenario", ex);
                Contexto.showMessage("Error. No pudo eliminar el escenario " + escenarioSelected.getNombre(),
    ...
    private void realRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_realRadioButtonActionPerformed
        fillEscenariosComboBox();
    }//GEN-LAST:event_realRadioButtonActionPerformed
